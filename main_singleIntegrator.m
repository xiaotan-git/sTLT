...
case_numb = 1;
dyn_model_name = 'singleIntegrator';
dyn.f = @(x,t) [0;0]; dyn.g= @(x,t) [1 0; 0 1];
size_state = 2; size_input = 2;
% case 1
...
switch case_numb
    ...
    case 2
        ...
        ' and F[13,14](G[0,4] mu3 and F[1,4] mu1) and G[0,20] (not mu4)' ...
        'and F[15,20] mu5'];
...
tree.updateALLRegions(); % TODO: add in vMax here
...
%     end
    ...
    % hard saturation
    lb = -vMax*ones(size_input,1); up = vMax*ones(size_input,1);
